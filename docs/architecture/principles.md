...
crates**, against 6.06 MiB and 122, and an order of magnitude is still an order
...
metrics, query, MCP and both UIs in it, the default build is **6.06 MiB
stripped, 122 crates** — the scale the design is defending.
