...
| **Four read surfaces, one binary** | Query API, MCP, browser UI and terminal UI over the same read path. 6.06 MiB stripped, 122 crates, no `protoc` and no node toolchain to build it. |
