...
| **Four read surfaces, one binary** | Query API, MCP, browser UI and terminal UI over the same read path. 6.18 MiB stripped, 148 crates, no `protoc` and no node toolchain to build it. |
