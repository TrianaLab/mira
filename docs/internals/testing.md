...
Mira has 428 cargo tests — 368 across levels 1–5, plus 60 in `xtask` that test
...
| --- | --- | --- | --- | --- |
| 1 | Unit, in-source | 146 core + 181 bin | `#[cfg(test)]` in the module under test | `make test` |
