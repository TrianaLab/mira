...
Mira has 430 cargo tests — 370 across levels 1–5, plus 60 in `xtask` that test
...
| --- | --- | --- | --- | --- |
| 1 | Unit, in-source | 146 core + 183 bin | `#[cfg(test)]` in the module under test | `make test` |
